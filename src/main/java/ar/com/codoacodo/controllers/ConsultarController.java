...
public class ConsultarController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			//resultset
			ResultSet rs = st.executeQuery(sql);  // se ejecuta el query
			
			if(rs.next()) {  //pregunto si hay datos
				...
				//ir a otra pagina y ademas pasarle datos. explicacion en min89 de la clase31

				//vamos a pasar a archivo detalle.jsp el objeto prodFromDb como atributo
